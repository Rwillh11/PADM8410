...
-   Example of a real pre-analysis plan: [Oregon Health Insurance Experiment PAP](https://www.nber.org/sites/default/files/2020-02/analysis-plan-voting-2015-09-23.pdf). Oregon randomly assigned Medicaid enrollment to low-income adults, then pre-registered the outcomes they would measure (ER use, health, finances).
:::
