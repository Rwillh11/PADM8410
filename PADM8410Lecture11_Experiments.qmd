...
ggplot(df_power, aes(x = x, y = density, color = group)) +
  ...
  annotate("text", x = mu0 - 0.2, y = 0.35, label = expression(H[0]), color = "#E74C3C", size = 5) +
  annotate("text", x = mu1 + 0.2, y = 0.35, label = expression(H[1]), color = "#1ABC9C", size = 5) +
  annotate("text", x = mu0, y = -0.01, label = "0") +
  annotate("text", x = mu1, y = -0.01, label = expression(beta)) +
