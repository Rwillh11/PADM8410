...
-   Example of a real pre-analysis plan: [Oregon Health Insurance Experiment PAP](https://www.nber.org/programs-projects/projects-and-centers/oregon-health-insurance-experiment/oregon-health-insurance-experiment-pre-analysis-plans). Oregon randomly assigned Medicaid enrollment to low-income adults, then pre-registered the outcomes they would measure (ER use, health, finances).
:::
...
## Why This Design Is Clever {.smaller}

::: incremental
-   The treatment vs. control comparison tells us "did the program work?" But the authors wanted to answer a harder question: **how much of the effect is from monitoring, and how much is from the financial incentive?**

-   The key insight is that the nonlinear pay structure creates variation in incentives *within* the treatment group. A teacher who has taught 9 days with several days left has a strong reason to show up: one more day crosses the 10-day threshold and unlocks the Rs. 50/day bonus for every day from 10 onward. But a teacher who has only taught 7 days with 2 days left *cannot* reach the threshold, so there is no marginal incentive to attend. Above 10 days, the incentive is a flat Rs. 50 per day.

-   By tracking daily attendance decisions and matching them to where each teacher stood relative to the threshold on each day, the authors can estimate how responsive teachers are to money vs. simply being watched

-   This lets them predict what *other* pay structures would do, without running a new experiment. They calculated that Seva Mandir could achieve the same attendance for 22% less money by adjusting the threshold and bonus amount
:::

## Design Details {.smaller}

::: incremental
-   The cameras solve the monitoring problem. Unannounced visits are expensive and infrequent. The camera gives daily, verifiable data at low cost

-   The five-hour and eight-student rules prevent gaming. You cannot just show up, snap a photo, and leave

-   Is this ethical? These are para-teachers on renewable contracts, not government employees with union protections. The control group kept their existing pay. No one was made worse off by the experiment
:::
